...
export default function ServicesPage() {
  ...
  },
  {
    ...
    description:
      "We assist parents and guardians with registering children as British citizens under the various statutory routes. Our advisors guide you through eligibility categories, evidence requirements, and legal complexities to ensure a well-prepared application.",
  },
  {
